...
exports.default = ESChildModel = function (superClass) {
  ...
  function ESChildModel() {
    ...
    if (!(this.parentBoundModel instanceof _ESBoundModel2.default)) {
  ...
  ESChildModel.prototype._checkParent = function (parent) {
    if (parent instanceof _ormojo.Instance) {
      return parent.id;
